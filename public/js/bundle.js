...
var itemExist = document.querySelector('#exist');
var fields = document.querySelectorAll('input, textarea, select');
itemExist.addEventListener('change', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var index, el;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          index = parseInt(itemExist.options[itemExist.selectedIndex].dataset.js);
          _context.next = 3;
          return getEl(index);
        case 3:
          el = _context.sent;
...
function addPlaceholder(campName, Comparador, el) {
  if (campName.name == Comparador) {
    ...
    campName.placeholder = "".concat(el[campName.name], " + ");
    campName.value = '';
  }
}
function getEl(_x) {
...
function _getEl() {
  _getEl = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(index) {
    var el;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch('/pesq').then(function (d) {
              return d.json();
            }).then(function (da) {
              el = da;
            });
          case 2:
            ...
            return _context2.abrupt("return", el[index]);
          case 4:
          case "end":
